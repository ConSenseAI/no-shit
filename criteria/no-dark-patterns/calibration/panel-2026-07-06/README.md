...
Coordinator: project owner. Criterion version adjudicated: **0.1.6** (current 0.1.7 records this run; no check, decision, or corpus changes). Blinding is honor-system plus packet construction; attestations are in the sheets verbatim.

## Results

n = 46, coverage 1.00. Inter-rater exact 46/46, **Cohen's κ = 1.00**; hard subset (boundary+adversarial, n = 15) 15/15; both raters 46/46 vs. the authored key; zero underdetermined. Scored with `tools/adjudication/score.py`.
