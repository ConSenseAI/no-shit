...
| [`validation/PROTOCOL.md`](validation/PROTOCOL.md) | The Stage 0 validation-study protocol: corpus and fixture construction, model pools, procedure under test, metrics, and the pre-stated kill criteria — freezes into the study's pre-registration before any execution | v0.1.2, draft |
