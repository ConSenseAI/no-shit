...
**Version:** 0.1.7 · **Status:** draft — §2's platform claims F0-proven 2026-07-10; F1 staged bench build 2026-07-11 + Ghost webhook-driven billing coupling proven 2026-07-16 ([`platform/`](../platform/)); sealed fixture-build underway, first sealed tranche through the full §6 gate cycle 2026-07-17; §7's stubs expanded to row grain at [`OBSERVATION-PARAMS.md`](OBSERVATION-PARAMS.md)
...
**Build conventions (hardened by the first sealed tranche, 2026-07-17 — normative for every fixture):**
