...
**Version:** 0.1.6 · **Status:** draft — §2's platform claims F0-proven 2026-07-10; F1 staged bench build 2026-07-11 + Ghost webhook-driven billing coupling proven 2026-07-16 ([`platform/`](../platform/)); sealed fixture-build underway; §7's stubs expanded to row grain at [`OBSERVATION-PARAMS.md`](OBSERVATION-PARAMS.md)
